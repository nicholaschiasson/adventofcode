...
pub fn part_02(input: &String) -> u64 {
	...
	basins.iter().take(3).fold(1, |s, b| s * b) as u64
}
...
mod tests {
	...
	#[test]
	fn part_01() {
		assert_eq!(super::part_01(&read_resource(relative_input_path(INPUT_PATH))), 537);
	}

	#[test]
	fn part_02() {
		assert_eq!(super::part_02(&read_resource(relative_input_path(INPUT_PATH))), 1142757);
	}
}
