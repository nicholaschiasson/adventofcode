...
mod tests {
	...
	mod year_2021 {
		...
		mod day_02 {
			use crate::tests::read_input;
			use crate::year_2021::day_02 as day;
			const DAY_NUM: u8 = 2;

			#[test]
			fn part_01() {
				assert_eq!(day::part_01(&read_input(super::YEAR_NUM, DAY_NUM)), 1989014);
			}
		...
		mod day_03 {
			...
			#[test]
			fn part_02() {
				assert_eq!(day::part_02(&read_input(super::YEAR_NUM, DAY_NUM)), 6677951);
			}
		}
		...
		mod day_04 {
			use crate::tests::read_input;
			use crate::year_2021::day_04 as day;
			const DAY_NUM: u8 = 4;

			#[test]
			fn part_01() {
				assert_eq!(day::part_01(&read_input(super::YEAR_NUM, DAY_NUM)), 64084);
			}

			#[test]
			fn part_02() {
				assert_eq!(day::part_02(&read_input(super::YEAR_NUM, DAY_NUM)), 12833);
			}
		}
		...
		mod day_05 {
			use crate::tests::read_input;
			use crate::year_2021::day_05 as day;
			const DAY_NUM: u8 = 5;

			#[test]
			fn part_01() {
				assert_eq!(day::part_01(&read_input(super::YEAR_NUM, DAY_NUM)), 5145);
			}

			#[test]
			fn part_02() {
				assert_eq!(day::part_02(&read_input(super::YEAR_NUM, DAY_NUM)), 16518);
			}
		}
		...
		mod day_06 {
			use crate::tests::read_input;
			use crate::year_2021::day_06 as day;
			const DAY_NUM: u8 = 6;

			#[test]
			fn part_01() {
				assert_eq!(day::part_01(&read_input(super::YEAR_NUM, DAY_NUM)), 356190);
			}

			#[test]
			fn part_02() {
				assert_eq!(day::part_02(&read_input(super::YEAR_NUM, DAY_NUM)), 1617359101538);
			}
		}
		...
		mod day_07 {
			use crate::tests::read_input;
			use crate::year_2021::day_07 as day;
			const DAY_NUM: u8 = 7;

			#[test]
			fn part_01() {
				assert_eq!(day::part_01(&read_input(super::YEAR_NUM, DAY_NUM)), 355989);
			}

			#[test]
			fn part_02() {
				assert_eq!(day::part_02(&String::from("16,1,2,0,4,2,7,1,2,14")), 168);
				assert_eq!(day::part_02(&read_input(super::YEAR_NUM, DAY_NUM)), 102245489);
			}
		}
	}
}
